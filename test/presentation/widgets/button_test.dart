...
void main() {
  ...
  group('Button tests', () {
    testWidgets('Button should display a title and icon',
    ...
    testWidgets('Button should only display a title',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        LocalizedMaterialApp(
          child: Button(
    ...
    testWidgets('Button should only display a icon',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        LocalizedMaterialApp(
          child: Button(
    ...
    testWidgets('Button should execute callback on tap',
        (WidgetTester tester) async {
